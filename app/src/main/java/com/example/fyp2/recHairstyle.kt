...
import com.example.fyp2.databinding.FragmentRecHairstyleBinding


class recHairstyle : Fragment() {

    private var gender: String = ""
    private var cat: String = ""
    private var id: String = ""

    private lateinit var binding: FragmentRecHairstyleBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            ...
            Log.d("inside rechairstyl","${gender.toString()} ${cat.toString()} ${id.toString()}")
        }
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentRecHairstyleBinding.inflate(inflater,container,false)
        ...
        vm.getHairstylesByGenderAndCategory(gender,cat).observe(viewLifecycleOwner){ list->
